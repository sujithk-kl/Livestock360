    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <aside className="w-72 bg-white shadow-lg flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          {[
            ...
            <button
              ...
              className="w-full text-left px-4 py-3 rounded-lg hover:bg-green-100 hover:text-green-700 transition font-medium"
            >
              {label}
            </button>
          ))}
        ...
        <div className="p-4 border-t">
          <p className="text-sm font-semibold">{farmerProfile.name}</p>
          <p className="text-xs text-gray-500 mb-3">Farmer Account</p>
          <button

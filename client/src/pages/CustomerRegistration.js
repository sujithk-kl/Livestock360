    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-extrabold text-gray-900 mb-2">Customer Registration</h2>
          <p className="text-sm text-gray-600">Create your Livestock360 customer account</p>
        </div>

        <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-8 max-w-2xl">
          {/* Success Message */}
          {successMessage && (

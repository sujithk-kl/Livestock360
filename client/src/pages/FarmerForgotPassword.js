...
const FarmerForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await api.post('/farmers/forgot-password', { email });
                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <Link to="/farmer/login" className="font-medium text-primary-600 hover:text-primary-500 transition-colors">
                                Sign in
                            </Link>
                        </p>
                    </div>

            ...
            <div className="flex-grow">
                <div className="max-w-7xl mx-auto px-6 py-16">
                    <div className="text-center mb-16">
                        <h1 className="text-4xl md:text-5xl font-bold font-serif text-gray-900 dark:text-white mb-6">{t('services_title')}</h1>
                    ...
                    {/* For Farmers */}
                    <div className="mb-20">
                        <h2 className="text-3xl font-bold font-serif text-primary-700 dark:text-primary-400 mb-10 text-center">{t('services_farmers_title')}</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                {
                                    title: t('service_livestock_mgmt'),
                                    desc: t('service_livestock_mgmt_desc'),
                                    icon: (
                                ...
                                {
                                    title: t('service_milk_tracking'),
                                    desc: t('service_milk_tracking_desc'),
                                    icon: (
                                        <svg className="w-8 h-8 text-primary-600 dark:text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                {
                                    title: t('service_sales_analytics'),
                                    desc: t('service_sales_analytics_desc'),
                                    icon: (
                                        <svg className="w-8 h-8 text-primary-600 dark:text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    {/* For Customers */}
                    <div className="mb-20">
                        <h2 className="text-3xl font-bold font-serif text-secondary-700 dark:text-secondary-400 mb-10 text-center">{t('services_customers_title')}</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                {
                                    title: t('service_direct_farm'),
                                    desc: t('service_direct_farm_desc'),
                                    icon: (
                                ...
                                {
                                    title: t('service_quality_assurance'),
                                    desc: t('service_quality_assurance_desc'),
                                    icon: (
                                        <svg className="w-8 h-8 text-secondary-600 dark:text-secondary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                {
                                    title: t('service_easy_ordering'),
                                    desc: t('service_easy_ordering_desc'),
                                    icon: (
                                        <svg className="w-8 h-8 text-secondary-600 dark:text-secondary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">

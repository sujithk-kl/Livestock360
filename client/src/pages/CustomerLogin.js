...
const CustomerLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 flex font-sans">
      {/* Left Side - Image (Customer Theme) */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: `url(${authBg})` }}
        ></div>
        <div className="absolute inset-0 bg-secondary-900/60 backdrop-blur-sm"></div> {/* Amber overlay for customers */}
        <div className="relative z-10 flex flex-col justify-between p-12 text-white h-full">
          ...
          <div>
            <h1 className="text-4xl font-serif font-bold mb-4">{t('role_customer_title')} Portal</h1>
            <p className="text-lg text-secondary-100 max-w-md leading-relaxed">
              Discover fresh, high-quality livestock products directly from local farmers.
            </p>
          </div>
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              New here?{' '}
              <Link to="/customer/register" className="font-medium text-secondary-600 hover:text-secondary-500 transition-colors">
                {t('register_customer_link')}
              </Link>
            </p>
          </div>
              ...
              <div>
                ...
                <div className="mt-2 relative rounded-md shadow-sm">
                  <input
                    ...
                    onChange={handleChange}
                    className="block w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 placeholder-gray-400 focus:ring-2 focus:ring-secondary-500 focus:border-transparent dark:bg-gray-800 dark:text-white transition pr-10"
                    placeholder="••••••••"
                  />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-secondary-600 focus:ring-secondary-500 border-gray-300 rounded cursor-pointer"
                  />
